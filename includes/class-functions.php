...
class Functions {
	...
	public static function sanitize_attribute( $attributes, $attribute, $type = 'text' ) {
		if ( isset( $attributes[ $attribute ] ) ) {
			switch ( $type ) {
				...
				case 'default':
					return new \WP_Error( 'tmjbd_unknown_type', __( 'Unknown type.', 'simple-comment-editing' ) );
			}
		}
		return new \WP_Error( 'tmjbd_attribute_not_found', __( 'Attribute not found.', 'simple-comment-editing' ) );
	}
	...
	public static function get_plugin_slug() {
		return dirname( plugin_basename( TMJ_FILE ) );
	}
	...
	public static function get_plugin_path() {
		return plugin_basename( TMJ_FILE );
	}
	...
	public static function get_plugin_version() {
		return TMJ_BLOG_DISCUSSION_VERSION;
	}
	...
	public static function get_plugin_logo() {
		 ...
		 */
		return apply_filters( 'tmjbd_plugin_logo_full', self::get_plugin_url( '/images/logo.png' ) );
	}
	...
	public static function get_plugin_author() {
		 ...
		 */
		$plugin_author = apply_filters( 'tmjbd_plugin_author', 'MediaRon LLC' );
	...
	public static function get_plugin_author_uri() {
		 ...
		 */
		$plugin_author = apply_filters( 'tmjbd_plugin_author_uri', 'https://mediaron.com' );
		return $plugin_author;
	}
	...
	public static function get_plugin_icon() {
		 ...
		 */
		return apply_filters( 'tmjbd_plugin_icon', self::get_plugin_url( '/images/logo.png' ) );
	}
	...
	public static function get_plugin_name() {
		 ...
		 */
		return apply_filters( 'tmjbd_plugin_name', __( 'Simple Comment Editing', 'simple-comment-editing' ) );
	}
	...
	public static function get_plugin_description() {
		 ...
		 */
		return apply_filters( 'tmjbd_plugin_description', __( 'Allow your users to edit comments.', 'simple-comment-editing' ) );
	}
	...
	public static function get_plugin_uri() {
		 ...
		 */
		return apply_filters( 'tmjbd_plugin_uri', 'https://mediaron.com/simple-comment-editing/' );
	}
	...
	public static function get_plugin_menu_name() {
		 ...
		 */
		return apply_filters( 'tmjbd_plugin_menu_name', __( 'Simple Comment Editing', 'simple-comment-editing' ) );
	}
	...
	public static function get_plugin_title() {
		 ...
		 * @param string Plugin Menu Name.
		 */
		return apply_filters( 'tmjbd_plugin_menu_title', self::get_plugin_name() );
	}
	...
	public static function get_plugin_dir( $path = '' ) {
		$dir = rtrim( plugin_dir_path( TMJ_FILE ), '/' );
	...
	public static function get_plugin_url( $path = '' ) {
		$dir = rtrim( plugin_dir_url( TMJ_FILE ), '/' );
		if ( ! empty( $path ) && is_string( $path ) ) {
			$dir .= '/' . ltrim( $path, '/' );
		}
		return $dir;
